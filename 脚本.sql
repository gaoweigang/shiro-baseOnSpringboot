...
CREATE TABLE `tbl_account` (
  ...
  `user_status` char(1) not null default '0' comment '账号状态(0：正常，1：密码过期，2：账户已冻结，3：已销户)',
  `valid_flag` TINYINT(1) not null default '1' comment '有效标志 1：有效，0：无效',
  create_time timestamp NULL DEFAULT NULL comment '创建时间',
  modify_time timestamp NULL DEFAULT NULL ON UPDATE CURRENT_TIMESTAMP COMMENT '修改时间',
  creator varchar(32) default null comment '创建人',
  modifier varchar(32) default null comment '修改人',
...
create table `tbl_user` (
  ...
  status tinyint(1) NOT NULL DEFAULT '1' comment '人员状态： 1：在职，0：离职，人员离职之后，账号则是注销状态',
...
INSERT INTO `tbl_user`(USER_ID,USERNAME,SEX,birthday,card_no,EMAIL,MOBILE,POSITION,VALID_FLAG,entry_time) VALUES ('00000014', 'admin', 0, '2018-3-12 16:40:00', '420881199101095180', '13817191469@163.com', '13817191469', '开发', 1, '2018-3-12 16:40:00');

INSERT INTO `tbl_account`(user_id,PASSWORD) VALUES ('00000012', '201810');
INSERT INTO `tbl_account`(user_id,PASSWORD) VALUES ('00000013', '201811');
INSERT INTO `tbl_account`(user_id,PASSWORD) VALUES ('00000014', '201812');
